...
urlpatterns = [
    ...
    path("api/v1/token/", PublicTokenObtainPairView.as_view(), name="token_obtain_pair"),
    path("api/v1/token/refresh/", PublicTokenRefreshView.as_view(), name="token_refresh"),
    path("api/v1/dashboard/stats/", DashboardStatsView.as_view(), name="dashboard-stats"),
    path("api/v1/alerts/ingest/", AlertIngestView.as_view(), name="alert-ingest"),
